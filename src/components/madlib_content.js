...
class MadlibContent extends Component {
    render() {
        ...
        return ( 
            ...
            between the Cleveland <b>{data.pluralNoun}</b> and the <b>{data.adjectiveOne}</b> Yankees. <b>{data.celebrityOne}</b> is 
            ...
            {data.adjectiveThree}</b> field. But <b>{data.celebrityTwo}</b> is coming up fast and has it for the second out. The next batter 
            up is <b>{data.celebrityThree}</b> the Cleveland <b>{data.adjectiveFour}</b>-stop. Here's the pitch... and it's hit... a short ground 
            ball to third <b>{data.nounThree}</b>. <b>{data.celebrityFour}</b> scoops it up and throws it to first base for an out and the 
